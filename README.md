...
4. Create an empty Amazon EBS volume with size require in the same availability zone
![volume](images/volume.png)

5. Attach both volumes to the instance and again note all device name details.
